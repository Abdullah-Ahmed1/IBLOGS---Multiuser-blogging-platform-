        ...
        >
          <CardMedia
            ...
            image={
              item.image
                ? item.image
                : "https://res.cloudinary.com/dlgwvuu5d/image/upload/v1660213469/my-uploads/phzatp2folb3pglrxkea.jpg"
            }
          />
          <CardContent textOverflow="ellipsis">
            <Link
              style={{ textDecoration: "none", color: "black" }}
              to={`/admin/users/blog-posts/${item._id}`}
            >
              <Typography
                gutterBottom
                variant="h6"
