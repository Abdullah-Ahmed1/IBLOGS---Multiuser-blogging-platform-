...
const ReaderHome = () => {
  ...
  const handleChipClick = (label) => {
    ...
    axios
      .get(`http://127.0.0.1:5000/readerDashboard/filter-with-tags/${label}`, {
        headers: {
  ...
  const handleLikeClick = (postId) => {
    ...
    axios
      .post(
        `http://127.0.0.1:5000/readerDashboard/add-like/${postId}`,
        {},
        {
          headers: {
            "Content-Type": "application/json",
      ...
      .then((res) => {
        console.log(res);
        axios
          .get("http://127.0.0.1:5000/readerDashboard", {
            headers: {
              "Content-Type": "application/json",
              Accept: "application/json",
              Authorization: token,
        ...
        <Grid2
          ...
          sx={
            small
              ...
              : { minHeight: "80vh", marginTop: "20px", marginLeft: "30px" }
          }
        >
          {/* ----------------------------------------------------------------------------------- */}
          {/* <Posts  posts = {posts}/> */}
            ...
            {trendingPosts !== null ? (
              trendingPosts.length > 0 ? (
                trendingPosts.map((item) => {
                  return <TrendPostCard key={item._id} item={item} />;
                })
              ) : (
