...
const ReaderPostCard = ({ item, handleLikeClick, handleNotInterested }) => {
  ...
  const handleChange = (event) => {
    ...
    checked ? console.log("cheked") : console.log("not cheked");
    ...
    if (event.target.checked) {
      ...
      axios
        .post(
          `http://127.0.0.1:5000/readerDashboard/add-to-reading-list/${item._id}`,
          {},
          {
            headers: {
      ...
      axios
        .delete(
          `http://127.0.0.1:5000/readerDashboard/remove-from-readingList/${item._id}`,
          {
            headers: {
              "Content-Type": "application/json",
              Accept: "application/json",
    ...
    axios
      ...
      .then((res) => {
        ...
        if (item) {
          ...
          res.data.ReadingList.includes(item._id)
            ? setChecked(true)
            : setChecked(false);
        }
          ...
          >
            ...
            >
              <Grid item lg={1} md={1} sm={1} xs={1}>
                <Avatar
                  alt={item.parentBlog.owner.firstname}
              ...
              >
                <Link
                  to={`/ReaderDashboard/author-profile/${item.parentBlog.owner._id}`}
                ...
                >
                  ...
                  >
                    ...
                    {item.parentBlog.owner.firstname}{" "}
                    {item.parentBlog.owner.lastname}{" "}
                    <span
                      style={
                        small ? { marginLeft: "10px" } : { marginLeft: "50px" }
                      }
                    >
                      {" "}
              ...
              <Grid item lg={2} sm={1} xs={1}>
                ...
                <PostCardMenu
                  ownerId={item.parentBlog.owner._id}
                  postId={item._id}
            ...
            >
              <Link
                to={`/ReaderDashboard/full-post/${item._id}`}
            ...
            <Grid container item sx={{ width: "90%", maxHeight: "20px" }}>
              ...
              >
                {checked ? (
                  <BookmarkAddedIcon sx={{ color: "#379863" }} />
                ) : (
                  <BookmarkAddIcon sx={{ color: "#05386b" }} />
                )}
              </Button>
              <CreateListMenu
          ...
          >
            <img
              ...
              src={
                item.postCardImage
                  ? item.postCardImage
                  : "https://res.cloudinary.com/dlgwvuu5d/image/upload/v1662389730/my-uploads/download_1_efhm00.png"
              }
              alt="image"
            />
          </Grid>
