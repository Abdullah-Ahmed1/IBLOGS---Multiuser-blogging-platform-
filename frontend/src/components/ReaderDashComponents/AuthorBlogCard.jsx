...
import "./../BlogComps/BlogCardMui.css";
import Aos from 'aos';
...
import BlogDeleteDialogue from './../BlogComps/BlogDelDialogue';
...
export default function AuthorBlogCard({item}) {
  ...
  return (
     <>
      ...
      <Link   style = {{textDecoration:"none",color:"black"}}  to= {`/readerdashboard/blog/${item._id}`}>
