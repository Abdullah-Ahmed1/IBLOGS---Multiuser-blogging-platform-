    ...
    if( notification.notificationType =="follow" ){
        ...
        {/* <Link to={`/readerDashboard/author-profile/${notification.info.followerId}`}> */}
            ...
            <Avatar
                ...
                sx={{ width: 24, height: 24 ,marginRight:"10px",marginLeft:"10px" }}
            />  
            <h4   style = {{padding:0,margin:0}}><span><Link style={{textDecoration:"none"}} to={`/readerDashboard/author-profile/${notification.info.followerId}`}>{notification.info.followerName}</Link></span> started following you</h4>
        ...
        <>
            ...
            <Grid2 container direction={"row"} alignItem={"center"}  lg = {10} sx = {{marginLeft:"10px",paddingRight:"40px"}}>
            <h4>Someone has reported you on post {notification.info.postTitle} as {notification.info.reason}</h4>
        </Grid2>
