...
// or import 'quill/dist/quill.bubble.css'; // Add css for bubble theme
 ...
 const Editor=({}) => {
  ...
  React.useEffect(() => {
    if (quill) {
      quill.clipboard.dangerouslyPasteHTML('<h1>you dont need to enter your Post title here</h1>');
    ...
    <div  style={{display:"flex",flexDirection:"column",marginTop:"20px"}} >
      <div>
           ...
           <div style={{margin:"auto"}}>
             <h3>Add title</h3>
              <textarea  value={title} onChange={e=>{setTitle(e.target.value)}} style={{fontSize:"30px",fontFamily:"arial"}} rows={2} cols={80}  ></textarea>
           </div>
