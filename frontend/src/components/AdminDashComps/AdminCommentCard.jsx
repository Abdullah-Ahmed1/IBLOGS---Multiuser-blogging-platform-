...
export default function AdminCommentCard({comment}) {
  ...
  return (
    <Card sx={{ maxWidth: 380, marginBottom:"10px" }}>
      <CardHeader onClick={()=>navigate(`/admin/users/detail/${comment.author._id}`)}  sx = {{cursor:"pointer",maxHeight:"50px",fontSize:"12px"}}
        avatar={
